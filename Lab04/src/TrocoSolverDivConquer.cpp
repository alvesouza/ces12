    ...
    unsigned int value, std::vector<unsigned int> &coinsProv)
{
    ...
    int aux1,aux2;//aux irão receber o numero de moedas necessarias para resolver
    ...
    aux1 = TrocoSolverDivConquer::recursiveTroco(denom, ultima,value - denom[ultima], coinsProv1);
